...
def summarize_calculation(training_configuration_file: str):
    with open((co.TRAINING_CONF_DIR/training_configuration_file).as_posix(), "r") as f:
        training_params = json.load(f)
    with open((co.PIPELINE_DIR/training_params["training_aux_data"]["pipeline_file"]).as_posix(), "r") as f:
