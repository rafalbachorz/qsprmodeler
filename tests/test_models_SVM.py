...
def test_SVM_Train_CV_regressor():
    ...
    m_r = mw.M_SVM(prediction_type=mw.Prediction_Type.REGRESSION, pipeline_configuration=pipeline_configuration)
...
def test_SVM_Train_CV_classifier():
    ...
    m_c = mw.M_SVM(prediction_type=mw.Prediction_Type.CLASSIFICATION, pipeline_configuration=pipeline_configuration)
